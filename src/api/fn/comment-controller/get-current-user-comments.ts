...
export function getCurrentUserComments(http: HttpClient, rootUrl: string, params?: GetCurrentUserComments$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<CommentDtoResponse>>> {
